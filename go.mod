...
require (
	github.com/openshift/api v0.0.0-20231205121914-b5716b30456a
...
replace github.com/openshift/api => github.com/JoshSalomon/api v0.0.0-20231219145725-1ede0ac59b30
